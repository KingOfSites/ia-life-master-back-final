			...
			messages: [
				{
					...
					content:
						[
							...
							...(wantsVeganOrVegetarian
								? [
										"6. USUÁRIO VEGETARIANO/VEGANO: NÃO use NENHUMA opção com carne, frango ou peixe. Para TODAS as refeições use EXCLUSIVAMENTE a seção 7 (CARDÁPIO VEGANO E VEGETARIANO) abaixo. Proibido: strogonoff de frango, frango grelhado, carne, peixe, atum, salmão, etc.",
									]
								: [
